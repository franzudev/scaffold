<header class="app-header navbar">
    <button class="navbar-toggler sidebar-toggler d-lg-none mr-auto shadow-none" type="button" aria-label="menu" data-toggle="sidebar-show">
    ...
    <button class="navbar-toggler sidebar-toggler d-md-down-none shadow-none" type="button" aria-label="menu" data-toggle="sidebar-lg-show">
        <span class="navbar-toggler-icon"></span>
    </button>
