        ...
        <div class="row">
            <div class="col-12">
                <div class="section__title text-center">
                    <h2 class="title__line">I NOSTRI <span class="text--theme"> PRODOTTI</span></h2>
            ...
            <div class="col-lg-4 col-xl-4 col-md-6 col-sm-6 col-12">
                <div class="service foo">
                    <div class="service__thumb">
                        <a href="{{ route('families', ['category' => $macro_category->id]) }}">
                            <img src="{{ $macro_category->image_url }}" alt="service images">
                        </a>
                        <div class="service__hover">
                            <div class="service__action">
                                <a href="{{ route('families', ['category' => $macro_category->id]) }}">DETAILS</a>
                            </div>
                        </div>
                    </div>
                    <div class="service__details">
                        <h2><a href="{{ route('families', ['category' => $macro_category->id]) }}">{{ $macro_category->name }}</a></h2>
                    </div>
                </div>
            </div>
            @endforeach
